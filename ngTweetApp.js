...
tweetApp.controller('TweetCtrl', function ($scope, $http, $interval, $timeout){
  // Get initial 10 tweets using json.php
  $http.get('json.php?count=10').success(function(data) {
    $scope.tweets = data;

    // HACK to wait until first 10 tweets have rendered in view
    $timeout(function() {
      // TODO - remove duplication with Factory/Service
      // Get next 90 tweets and push them to the end of tweets
  ...
  // Last 90 tweets left to render at their leisure. 
